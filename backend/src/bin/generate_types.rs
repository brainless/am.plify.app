...
fn main() {
    ...
    fs::write("../webapp/src/types/generated/HealthResponse.ts", format!("export {};", health_ts)).unwrap();
    fs::write("../webapp/src/types/generated/HelloResponse.ts", format!("export {};", hello_ts)).unwrap();
    fs::write("../webapp/src/types/generated/ApiError.ts", format!("export {};", error_ts)).unwrap();
